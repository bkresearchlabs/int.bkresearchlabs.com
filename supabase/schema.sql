...
CREATE TABLE IF NOT EXISTS public.products (
  ...
  acknowledgment_text TEXT DEFAULT 'I acknowledge that this chemical reagent is purchased strictly for research purposes.',
...
CREATE TABLE IF NOT EXISTS public.homepage_content (
  ...
  hero_subtitle TEXT DEFAULT 'HPLC-verified research reagents with lot-specific Certificates of Analysis.',
  hero_badge TEXT DEFAULT 'ISO 9001:2015 Certified Reagent Supply',
  hero_cta_text TEXT DEFAULT 'Explore Reagent Catalog',
  banner_announcement TEXT DEFAULT '⚡ Same-Day Cold-Chain Express Shipping on Orders Placed Before 2:00 PM EST',
...
-- Allow public read access for catalog & content
...
-- Allow full access for anon/service role or operational backend queries
...
VALUES 
  ('cat-compounds', 'Analytical Compounds & Reagents', 'analytical-compounds', 'High-purity research compounds and reference standards.', 'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?auto=format&fit=crop&q=80&w=800', 1, true)
ON CONFLICT (id) DO NOTHING;
...
VALUES ('main', 'High-Purity Analytical Compounds for Scientific Excellence', 'HPLC-verified research reagents with lot-specific Certificates of Analysis.', 'ISO 9001:2015 Certified Reagent Supply', 'Explore Reagent Catalog', '⚡ Same-Day Cold-Chain Express Shipping on Orders Placed Before 2:00 PM EST')
ON CONFLICT (id) DO NOTHING;
